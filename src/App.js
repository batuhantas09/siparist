    ...
    return (
        <div className="min-h-screen bg-gray-100 font-inter flex flex-col">
            ...
            <footer className="bg-gray-800 text-white p-4 text-center text-sm">
                <p>&copy; {new Date().getFullYear()} siparist. Tüm Hakları Saklıdır.</p>
                <p className="mt-1">Kullanıcı ID: {userId || 'Yükleniyor...'}</p>
            </footer>
        </div>
    );
}
                                ...
                                <div key={item.id} className="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <input
                                            ...
                                            className="mt-2 p-2 w-full border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500"
                                        />
                                    </div>
